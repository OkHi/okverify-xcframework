...
@interface OkHiVerify (SWIFT_EXTENSION(OkVerify)) <CLLocationManagerDelegate>
...
@interface OkHiVerify (SWIFT_EXTENSION(OkVerify))
...
SWIFT_CLASS("_TtC8OkVerify16OkVerifyGeofence")
...
@interface OkVerifyGeofence (SWIFT_EXTENSION(OkVerify))
...
SWIFT_CLASS("_TtC8OkVerify26OkVerifyGeofenceTransition")
...
@interface OkVerifyGeofenceTransition (SWIFT_EXTENSION(OkVerify))
...
SWIFT_CLASS("_TtC8OkVerify12OkVerifyUser")
@interface OkVerifyUser : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface OkVerifyUser (SWIFT_EXTENSION(OkVerify))
